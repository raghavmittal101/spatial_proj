...
public class Demo : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        ImportRobot();
        CreateRosConnection();
        CreateTrajectoryPlannerPublisher(target, targetPlacement);
    ...
    void CreateTrajectoryPlannerPublisher(GameObject target, GameObject targetPlacement, GameObject robot)
    {
        ...
        planner.NiryoOne = robot;
        planner.Target = target;
        planner.TargetPlacement = targetPlacement;
    }

    void CreateTrajectoryPlannerPublisher(GameObject target, GameObject targetPlacement)
    {
        var publisher = new GameObject(k_PublisherName);
        dynamic planner = publisher.AddComponent(m_Assembly.GetType(k_TrajectoryPlannerType));
        planner.RosServiceName = k_RosServiceName;
    ...
    GameObject InstantiatePrefab(string name, GameObject prefab)
    {
    ...
    void ImportRobot(GameObject robot)
    {
